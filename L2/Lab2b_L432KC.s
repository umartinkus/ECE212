...
LDR R2, =0X20001004 //x data points (addresses)
LDR R3, =0X20001008 //y data points (addresses)
...
CMP R6,R5 //check if we have read all of the points
BGT END //exit program if we have
B INTEGRATE //integrate until all data points have been addressed

INTEGRATE:
LDR R5, [R2], #4 //bring nth data point into calc register 1
LDR R7, [R2] //bring n+1th data point into calc register 2
